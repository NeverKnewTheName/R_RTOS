# 1 "../source/R_RTOS/R_RTOS_stack.c"
...
# 1 "../source/R_RTOS/R_RTOS_stack.c"
# 9 "../source/R_RTOS/R_RTOS_stack.c"
...
# 10 "../source/R_RTOS/R_RTOS_stack.c" 2
...
# 11 "../source/R_RTOS/R_RTOS_stack.c" 2
                         ...
                         register StackSize desiredStackSize )
{
    ...
    register StackPtrT stckPtr = (volatile StackPtrT) rMalloc(
            (MemSize) desiredStackSize );
    if ( (uint32_t) stckPtr != (uint32_t) ((void *)0x0u) )
    {
        stckPtr =
    ...
    else
    {
        ...
        tsk->pStckTop = (StackPtrT) ((void *)0x0u);
        tsk->pStckPtr = (volatile StackPtrT) ((void *)0x0u);
...
RetCode stk_StackInit( register PTskTCB tsk, void *fktParam )
{
    ...
    {
        stckPtr--;
        *stckPtr = ( (uint32_t)0x01000000u );
        stckPtr--;
        *stckPtr = (StackTypeT) tsk->pTskStrt;
        stckPtr--;
        *stckPtr = (StackTypeT) tsk->pTskEnd;
        stckPtr -= (uint32_t) 0x5u;
        *stckPtr = (StackTypeT) fktParam;
        stckPtr -= (uint32_t) 0x8u;

        tsk->pStckPtr = stckPtr;
# 108 "../source/R_RTOS/R_RTOS_stack.c"
        return ((RetCode)0x1u);
    }
    else
    {
...
RetCode stk_StackDestroy( register PTskTCB tsk )
{
    ...
    if ( (uint32_t) stckPtr != (uint32_t) ((void *)0x0u) )
    {
        ...
        rFree( stckPtr );
        tsk->pStckTop = (const StackPtrT) ((void *)0x0u);
        tsk->pStckPtr = (volatile StackPtrT) ((void *)0x0u);
        tsk->stckSze = (StackSize) 0x0u;
        return ((RetCode)0x1u);
    }
...
RetCode stk_TSTStck( PTskTCB const tsk )
{
    ...
    register volatile StackPtrT stckPtr = (volatile StackPtrT) tsk->pStckTop;
    if ( (uint32_t) stckTopPtr != (uint32_t) ((void *)0x0u) )
    {
