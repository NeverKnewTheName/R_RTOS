...
# 1 "../source/R_RTOS/R_RTOS_monitor.c"
# 10 "../source/R_RTOS/R_RTOS_monitor.c"
...
# 13 "../source/R_RTOS/R_RTOS_monitor.c" 2
...
{
# 41 "../source/R_RTOS/R_RTOS_monitor.c"
    return ((RetCode)0x1u);
}
...
RetCode mntr_INIT( void )
{
    return memMngr_CreateMemPool(
            sizeof(Mntr), (uint8_t)0x10u, &memPoolID_MNTR );
}
...
RetCode mntr_CreateMntr(
                         ...
                         const uint8_t waitrQueueMaxSize )
{
    if ( (uint32_t) ( usrMntrHndl ) == (uint32_t) ((void *)0x0u) )
        return ((RetCode)0x0u);

    if ( (uint32_t) ( *usrMntrHndl = (PMntr) rMalloc( sizeof(Mntr) ) ) == (uint32_t) ((void *)0x0u) )
        return ((RetCode)0x0u);
# 80 "../source/R_RTOS/R_RTOS_monitor.c"
    return ((RetCode)0x1u);
}
...

{
    ...
    mntrHndl->mntrWaitrsQTskIDStrt = ((TskID)0x0u);
    mntrHndl->mntrWaitrsQTskIDEnd = ((TskID)0x0u);
}
...
RetCode mntr_DestrMntr( PMntr * usrMntrHndl )
{
    ...
    if ( (uint32_t) ( *usrMntrHndl ) == (uint32_t) ((void *)0x0u) )
        return ((RetCode)0x0u);
# 116 "../source/R_RTOS/R_RTOS_monitor.c"
    memMngr_DeleteMemPool( memPoolID_MNTR );
    rFree( ( *usrMntrHndl )->protectedData );
    rFree( *usrMntrHndl );
    *usrMntrHndl = ((void *)0x0u);
    return ((RetCode)0x1u);
}
...
RetCode mntr_ReqstReadAccssMntr( Mntr * const usrMntrHndl, TskID tskID )
{
    ...
    else if ( usrMntrHndl->curState & MNTR_FREE )
    {

        ++( usrMntrHndl->refCntr );
        return ((RetCode)0x1u);
    }
    else if ( usrMntrHndl->curState & MNTR_WRITE )
    {




        PMntrWaitr mntrWaitrRead;
...
# 170 "../source/R_RTOS/R_RTOS_monitor.c"
        }
        return ((RetCode)0x0u);
    }
    else
...
RetCode mntr_RelsReadAccssMntr( Mntr * const usrMntrHndl )
{
    ...
    else if ( usrMntrHndl->curState & MNTR_RPW )
    {
...
RetCode mntr_ReqstWriteAccssMntr( Mntr * const usrMntrHndl, TskID tskID )
{
    ...
    else if ( usrMntrHndl->curState & MNTR_FREE_NOOP )
    {
    ...
    {
# 264 "../source/R_RTOS/R_RTOS_monitor.c"
        return ((RetCode)0x0u);
    }
}
...
RetCode mntr_RelsWriteAccssMntr( Mntr * const usrMntrHndl )
{
    ...
    {
# 334 "../source/R_RTOS/R_RTOS_monitor.c"
        return ((RetCode)0x1u);
    }
}
