# 1 "../hal/mcu/NXP_KL05/source/TimerFunc.c"
...
# 9 "../hal/mcu/NXP_KL05/source/TimerFunc.c" 2
...
# 11 "../hal/mcu/NXP_KL05/source/TimerFunc.c" 2
...
# 12 "../hal/mcu/NXP_KL05/source/TimerFunc.c" 2
...
# 1 "../hal/mcu/NXP_KL05/BSP/include/MKL05Z4.h" 1
# 17 "../hal/mcu/NXP_KL05/include/PortFunc.h" 2
# 26 "../hal/mcu/NXP_KL05/include/PortFunc.h"
...
#define PORTSELECT(port_num) ( ( port_num ) ? PORTB_BASE_PTR : PORTA_BASE_PTR )
#define PTSELECT(port_num) ( ( port_num ) ? PTB_BASE_PTR : PTA_BASE_PTR )

#define PORTNR(pin) ((uint8_t)( (PortPIN)pin >> PORT_SHIFT ))
#define PINNR(pin) ((uint8_t)((( (PortPIN)pin & (PortPIN)0xF0FFu ) & (PortPIN)0x7C) >> 0x2u ))
#define PINMASK(pin) ((uint32_t)( 0x1u << PINNR((PortPIN)pin) ) )
...
#define SET_PIN_HIGH_PORT(pin,port) (((PortPIN)pin != NC) && GET_PIN_DDR_PORT(pin,port)) ? ( GPIO_PSOR_REG(port) |= PINMASK((PortPIN)pin)) : NC
#define SET_PIN_HIGH(pin) SET_PIN_HIGH_PORT(pin, ((PORTNR((PortPIN)pin)) ? GPIOB : GPIOA))
#define SET_PIN_LOW_PORT(pin,port) (((PortPIN)pin != NC) && GET_PIN_DDR_PORT(pin,port)) ? ( GPIO_PCOR_REG(port) |= PINMASK((PortPIN)pin)) : NC
#define SET_PIN_LOW(pin) SET_PIN_LOW_PORT(pin, ((PORTNR((PortPIN)pin)) ? GPIOB : GPIOA))
#define TOGGLE_PIN_PORT(pin,port) (((PortPIN)pin != NC) && GET_PIN_DDR_PORT(pin,port)) ? ( GPIO_PTOR_REG(port) |= PINMASK((PortPIN)pin)) : NC
#define TOGGLE_PIN(pin) TOGGLE_PIN_PORT(pin, ((PORTNR((PortPIN)pin)) ? GPIOB : GPIOA))
#define GET_PIN_LVL_PORT(pin,port) (uint8_t)((((PortPIN)pin != NC) && GET_PIN_DDR_PORT(pin,port)) ? ((GPIO_PDOR_REG(port) & PINMASK( (PortPIN)pin ) ) >> PINNR( (PortPIN)pin )) : NC)
#define GET_PIN_LVL(pin) GET_PIN_LVL_PORT(pin, ((PORTNR((PortPIN)pin)) ? GPIOB : GPIOA))

#define READ_PIN_PORT(pin,port) (uint8_t)((((PortPIN)pin == NC) || GET_PIN_DDR_PORT(pin,port)) ? NC : ( GPIO_PDIR_REG(port) & PINMASK( (PortPIN)pin ) ) >> PINNR( (PortPIN)pin ))
#define READ_PIN(pin) READ_PIN_PORT(pin, ((PORTNR((PortPIN)pin)) ? GPIOB : GPIOA))
# 156 "../hal/mcu/NXP_KL05/include/PortFunc.h"
void initPin( const EfiFreePIN pin, const uint8_t mode, const uint8_t pullUp );
# 172 "../hal/mcu/NXP_KL05/include/PortFunc.h"
void setPin( const EfiFreePIN pin, const uint8_t val );
# 187 "../hal/mcu/NXP_KL05/include/PortFunc.h"
void togglePin( const EfiFreePIN pin );
# 203 "../hal/mcu/NXP_KL05/include/PortFunc.h"
uint8_t readPin( const EfiFreePIN pin );
# 13 "../hal/mcu/NXP_KL05/source/TimerFunc.c" 2
# 1 "../hal/mcu/NXP_KL05/include/ClockFunc.h" 1
# 9 "../hal/mcu/NXP_KL05/include/ClockFunc.h"
#define HEADERS_CLOCKFUNC_H_ 
# 24 "../hal/mcu/NXP_KL05/include/ClockFunc.h"
uint32_t getBusClk(void);
# 14 "../hal/mcu/NXP_KL05/source/TimerFunc.c" 2
...
void __initTMRFlags( void )
{
    ...
    ((((SIM_Type *)(0x40047000u)))->SOPT1) = (((uint32_t)(((uint32_t)(0x0u))<<18))&0xC0000u);


    (((OSC_Type *)(0x40065000u)))->CR |= (((uint8_t)(((uint8_t)(0x1u))<<7))&0x80u) | (((uint8_t)(((uint8_t)(0x1u))<<5))&0x20u);
}
# 66 "../hal/mcu/NXP_KL05/source/TimerFunc.c"
void __init_PIT( void )
{

    (((SIM_Type *)(0x40047000u)))->SCGC6 |= 0x800000u;

    (((PIT_Type *)(0x40037000u)))->MCR = (((uint32_t)(((uint32_t)(0x0u))<<1))&0x2u) | (((uint32_t)(((uint32_t)(0x1u))<<0))&0x1u);
...
# 93 "../hal/mcu/NXP_KL05/source/TimerFunc.c"
void resetPIT( uint32_t currentPITVal )
{


    (((PIT_Type *)(0x40037000u)))->CHANNEL[0].TCTRL &= ( (uint32_t) ( ~0x1u ) );

    (((PIT_Type *)(0x40037000u)))->CHANNEL[1].TCTRL &= ( (uint32_t) ( ~0x1u ) );


    (((PIT_Type *)(0x40037000u)))->CHANNEL[1].LDVAL = currentPITVal;


    (((PIT_Type *)(0x40037000u)))->CHANNEL[1].TCTRL |= (uint32_t) ( 0x4u
            | 0x1u );

    if ( gTMRFlags.g_PITtimerInitialized == (uint8_t) 0 )
    {

        (((PIT_Type *)(0x40037000u)))->CHANNEL[0].LDVAL =
    ...
    (((PIT_Type *)(0x40037000u)))->CHANNEL[0].TCTRL |= 0x1u;
}
...
void calibratePITWithTPM( uint8_t calibrationCycles )
{
    ...
    while ( calibrationCycles-- )
    {
        ...
        resetPIT( (uint32_t) ( ~(uint32_t)(~( (((PIT_Type *)(0x40037000u)))->CHANNEL[1].CVAL )) ) );
    }
...
void startPITCalibrationWithTPM( void )
{
    g_PITStartTime = (uint32_t)(~( (((PIT_Type *)(0x40037000u)))->CHANNEL[1].CVAL ));
    installIrq( &endPITCalibrationWithTPM, TPM1_IRQ_INDEX, (uint8_t) 0x0u );
}

void endPITCalibrationWithTPM( void )
{
    g_calibrationFactorPIT += (uint32_t) ( (uint32_t)(~( (((PIT_Type *)(0x40037000u)))->CHANNEL[1].CVAL )) - g_PITStartTime
                                           - (uint32_t) 1000 );
    installIrq( &dummyFkt, TPM1_IRQ_INDEX, (uint8_t) 0x0u );
    gTMRFlags.g_calibrationOngoing = 0u;
}
# 179 "../hal/mcu/NXP_KL05/source/TimerFunc.c"
void disablePITInterrupt( void )
{
    (((PIT_Type *)(0x40037000u)))->CHANNEL[1].TCTRL &= ~0x1u;

    (((PIT_Type *)(0x40037000u)))->CHANNEL[1].TCTRL &= ~0x2u;
    (((PIT_Type *)(0x40037000u)))->CHANNEL[1].TCTRL |= 0x1u;
}
# 200 "../hal/mcu/NXP_KL05/source/TimerFunc.c"
uint32_t readPIT( void )
{
    if ( gTMRFlags.g_PITtimerInitialized == (uint8_t) 0 )
    {
    ...
    return ~( (((PIT_Type *)(0x40037000u)))->CHANNEL[1].CVAL );
}
# 223 "../hal/mcu/NXP_KL05/source/TimerFunc.c"
void wait_ms( const uint32_t ms )
{
    uint32_t start = (uint32_t)(~( (((PIT_Type *)(0x40037000u)))->CHANNEL[1].CVAL ));
    while ( (uint8_t)(( (uint32_t)(~( (((PIT_Type *)(0x40037000u)))->CHANNEL[1].CVAL )) - ((uint32_t)(start)) ) < ( (uint32_t)(ms))) )
    {
        ;
    }
}
# 244 "../hal/mcu/NXP_KL05/source/TimerFunc.c"
void __init_LPTMR( void )
{
    (((SIM_Type *)(0x40047000u)))->SCGC5 |= 0x1u;

    (((LPTMR_Type *)(0x40040000u)))->CSR = (uint32_t) 0x0u;

            (((MCG_Type *)(0x40064000u)))->C1 &= ( (uint8_t) ( ~0x2u ) );

            (((MCG_Type *)(0x40064000u)))->C1 |= 0x2u;

            (((MCG_Type *)(0x40064000u)))->C2 |= 0x1u;

            NVIC_ClearPendingIRQ( LPTMR0_IRQn ); NVIC_EnableIRQ( LPTMR0_IRQn );
            NVIC_SetPriority( LPTMR0_IRQn, 2 );

            (((LPTMR_Type *)(0x40040000u)))->PSR =
            ( (((uint32_t)(((uint32_t)(0x0u))<<3))&0x78u) | (((uint32_t)(((uint32_t)(0x0u))<<0))&0x3u) );
# 270 "../hal/mcu/NXP_KL05/source/TimerFunc.c"
    gTMRFlags.g_LMPTRtimerInitialized = 1;
}
# 324 "../hal/mcu/NXP_KL05/source/TimerFunc.c"
void setLPTMR( uint16_t timerVal )
{
    timerVal = (uint16_t) ( timerVal );

    (((LPTMR_Type *)(0x40040000u)))->CSR &= (uint32_t) ( ~0x1u );
    (((LPTMR_Type *)(0x40040000u)))->CMR = (((uint32_t)(((uint32_t)(timerVal))<<0))&0xFFFFu);


    (((LPTMR_Type *)(0x40040000u)))->CSR = (uint32_t) ( 0x80u
                                        | (((uint32_t)(((uint32_t)(0x0u))<<3))&0x8u)
                                        | (((uint32_t)(((uint32_t)(0x0u))<<2))&0x4u)
                                        | (((uint32_t)(((uint32_t)(0x0u))<<1))&0x2u) );

    (((LPTMR_Type *)(0x40040000u)))->CSR |= 0x1u;


    (((LPTMR_Type *)(0x40040000u)))->CSR |= 0x40u;
}
# 356 "../hal/mcu/NXP_KL05/source/TimerFunc.c"
uint16_t readLPTMR( void )
{
    ...
    (((LPTMR_Type *)(0x40040000u)))->CNR = (uint16_t) 0x1u;
    return ( (uint16_t) (((LPTMR_Type *)(0x40040000u)))->CNR );
}
# 380 "../hal/mcu/NXP_KL05/source/TimerFunc.c"
void __init_RTC( void )
{
# 391 "../hal/mcu/NXP_KL05/source/TimerFunc.c"
    ((((SIM_Type *)(0x40047000u)))->SCGC6) |= 0x20000000u;
# 400 "../hal/mcu/NXP_KL05/source/TimerFunc.c"
    (((RTC_Type *)(0x4003D000u)))->CR = 0x1u;

    (((RTC_Type *)(0x4003D000u)))->CR &= ~0x1u;


    (((RTC_Type *)(0x4003D000u)))->CR |= 0x100u;
    do { uint32_t dummyStartTime = (uint32_t)(~( (((PIT_Type *)(0x40037000u)))->CHANNEL[1].CVAL )); while( (uint8_t)(( (uint32_t)(~( (((PIT_Type *)(0x40037000u)))->CHANNEL[1].CVAL )) - ((uint32_t)(dummyStartTime)) ) < ( (uint32_t)((uint16_t)150u))) ){__NOP();} }while((uint8_t)0x0u);


    if ( (((RTC_Type *)(0x4003D000u)))->SR & 0x1u )
    {
        (((RTC_Type *)(0x4003D000u)))->TSR = (uint32_t)0x00000001;
    }


    (((RTC_Type *)(0x4003D000u)))->TCR = (((uint32_t)(((uint32_t)(0))<<8))&0xFF00u) | (((uint32_t)(((uint32_t)(0xFFu))<<0))&0xFFu);


    (((RTC_Type *)(0x4003D000u)))->TSR = (uint32_t)0x1u;
...
# 442 "../hal/mcu/NXP_KL05/source/TimerFunc.c"
void rtcIntHandler( void )
{
...
# 464 "../hal/mcu/NXP_KL05/source/TimerFunc.c"
void enableRTCInterrupt( void )
{

    (((RTC_Type *)(0x4003D000u)))->IER |= 0x10u;
    foo = ((void *)0x0);
}
# 483 "../hal/mcu/NXP_KL05/source/TimerFunc.c"
void disableRTCInterrupt( void )
{

    (((RTC_Type *)(0x4003D000u)))->IER &= ~0x10u;
}
# 502 "../hal/mcu/NXP_KL05/source/TimerFunc.c"
uint32_t readRTC( void )
{
    return (((RTC_Type *)(0x4003D000u)))->TSR;
}
# 521 "../hal/mcu/NXP_KL05/source/TimerFunc.c"
void setRTC( uint32_t tSec )
{
    ...
    (((RTC_Type *)(0x4003D000u)))->TSR = tSec;
# 544 "../hal/mcu/NXP_KL05/source/TimerFunc.c"
    (((RTC_Type *)(0x4003D000u)))->SR |= 0x10u;
}
# 561 "../hal/mcu/NXP_KL05/source/TimerFunc.c"
void __init_TPM( const uint8_t timer )
{
    TPM_Type * tpmBasePtr = ( timer ) ? (((TPM_Type *)(0x40039000u))) : (((TPM_Type *)(0x40038000u)));

    ((SIM_Type *)(0x40047000u))->SCGC6 |= ( timer ) ? 0x2000000u : 0x1000000u;

    ((SIM_Type *)(0x40047000u))->SOPT2 |= (((uint32_t)(((uint32_t)(0x2u))<<24))&0x3000000u);
    ...
    tpmBasePtr->SC = (((uint32_t)(((uint32_t)(0x0u))<<3))&0x18u);


    tpmBasePtr->SC |= (((uint32_t)(((uint32_t)(0x1u))<<3))&0x18u) | (((uint32_t)(((uint32_t)(0x5u))<<0))&0x7u);
    tpmBasePtr->CONF |= 0x20u;
...
# 610 "../hal/mcu/NXP_KL05/source/TimerFunc.c"
void __init_TPMChannel(
                        const uint8_t timer,
                        const uint8_t channelNr,
                        const uint16_t timeInMs )
{
    if ( !( ( timer ) ?
            gTMRFlags.g_TPM1TimerInitialized : gTMRFlags.g_TPM0TimerInitialized ) )
    {
        __init_TPM( timer );
    }
...
# 642 "../hal/mcu/NXP_KL05/source/TimerFunc.c"
void stopTPMChannel( const uint8_t timer, const uint8_t channelNr )
{
    TPM_Type * tpmBasePtr = ( timer ) ? (((TPM_Type *)(0x40039000u))) : (((TPM_Type *)(0x40038000u)));
    ...
    while ( tpmBasePtr->CONTROLS[channelNr].CnSC & (uint16_t) ( 0x20u
            | 0x10u | 0x8u | 0x4u ) )
    {

        tpmBasePtr->CONTROLS[channelNr].CnSC =
        (((uint32_t)(((uint32_t)(0x0u))<<5))&0x20u)

        | (((uint32_t)(((uint32_t)(0x0u))<<4))&0x10u) | (((uint32_t)(((uint32_t)(0x0u))<<3))&0x8u) | (((uint32_t)(((uint32_t)(0x0u))<<2))&0x4u);
    ...
    while ( ( (uint16_t) ( tpmBasePtr->CONTROLS[channelNr].CnV
            ...
            != (uint32_t) 0x0u )
    {
        tpmBasePtr->CONTROLS[channelNr].CnV = (uint32_t) 0x0u;
    }
}
# 686 "../hal/mcu/NXP_KL05/source/TimerFunc.c"
void startTPMChannel( const uint8_t timer, const uint8_t channelNr )
{
    TPM_Type * tpmBasePtr = ( timer ) ? (((TPM_Type *)(0x40039000u))) : (((TPM_Type *)(0x40038000u)));
    uint16_t calculatedTime = gAr_TPMTimers[timer][channelNr];
    uint32_t offset = tpmBasePtr->CNT + calculatedTime;
    calculatedTime = (uint16_t) (
            ( offset > (uint32_t) 0xFFFF ) ?
                    ( offset - (uint32_t) 0xFFFF ) : offset );


    while ( ( tpmBasePtr->CONTROLS[channelNr].CnSC
            != (uint16_t) (
            0x40u | (((uint32_t)(((uint32_t)(0x0u))<<5))&0x20u) | (((uint32_t)(((uint32_t)(0x1u))<<4))&0x10u)
            | (((uint32_t)(((uint32_t)(0x0u))<<3))&0x8u) | (((uint32_t)(((uint32_t)(0x0u))<<2))&0x4u) ) ) )
    {
        ...
        tpmBasePtr->CONTROLS[channelNr].CnSC =
                0x80u | 0x40u
                | (((uint32_t)(((uint32_t)(0x0u))<<5))&0x20u)
                               | (((uint32_t)(((uint32_t)(0x1u))<<4))&0x10u) | (((uint32_t)(((uint32_t)(0x0u))<<3))&0x8u) | (((uint32_t)(((uint32_t)(0x0u))<<2))&0x4u);

    }
# 719 "../hal/mcu/NXP_KL05/source/TimerFunc.c"
    while ( ( (uint16_t) ( tpmBasePtr->CONTROLS[channelNr].CnV
            & (uint32_t) 0xFFFFu ) )
            != calculatedTime )
    {
        tpmBasePtr->CONTROLS[channelNr].CnV = calculatedTime;
    }
}
# 742 "../hal/mcu/NXP_KL05/source/TimerFunc.c"
void re_setTPMTimer( const uint8_t timer, const uint8_t channelNr )
{
...
{
    int32_t remTime =
            (int32_t) ( (int32_t) ( ( ( timer ) ? (((TPM_Type *)(0x40039000u))) : (((TPM_Type *)(0x40038000u))) )->CONTROLS[channelNr].CnV
                    & (uint32_t) 0xFFFFu )
                        - (int32_t) ( (
                                ( timer ) ? (((TPM_Type *)(0x40039000u))) : (((TPM_Type *)(0x40038000u))) )->CNT
                                      & (uint32_t) 0xFFFFu ) );
...
void correctTPMChannel( const uint8_t timer, const uint16_t chCorr )
{
    ...
    for ( tpmChCnt = (uint8_t) 0x0u;
            tpmChCnt < ( ( timer ) ? (uint8_t)0x2u : (uint8_t)0x6u );
            tpmChCnt++ )
    {
        if ( gAr_TPMTimers[timer][tpmChCnt] != (uint16_t) 0x0u )
        {
            ...
            gAr_TPMTimers[timer][tpmChCnt] = ( (uint16_t) correctedTPMTime );
...
void __disableTPMTimers( void )
{
    ...
    {
        while ( (((TPM_Type *)(0x40038000u)))->SC & (((uint32_t)(((uint32_t)(0x1u))<<3))&0x18u) )
        {
            (((TPM_Type *)(0x40038000u)))->SC &= ~0x18u;
        }
    }
    if ( gTMRFlags.g_TPM1TimerInitialized )
    {
        while ( (((TPM_Type *)(0x40039000u)))->SC & (((uint32_t)(((uint32_t)(0x1u))<<3))&0x18u) )
        {
            (((TPM_Type *)(0x40039000u)))->SC &= ~0x18u;
        }
    }
}
...
{
    if ( gTMRFlags.g_TPM0TimerInitialized )
        (((TPM_Type *)(0x40038000u)))->SC |= (((uint32_t)(((uint32_t)(0x1u))<<3))&0x18u);

    if ( gTMRFlags.g_TPM1TimerInitialized )
        (((TPM_Type *)(0x40039000u)))->SC |= (((uint32_t)(((uint32_t)(0x1u))<<3))&0x18u);
...
uint16_t findShortesTPM( void )
{
    ...
    while ( tmrCnt-- )
    {
        ...
        chnlCnt = ( actvTPMTmrs[tmrCnt] ) ? (uint8_t)0x2u : (uint8_t)0x6u;
    ...
    return ( (uint16_t) ( (uint32_t) tpmSetTime ) );
}
