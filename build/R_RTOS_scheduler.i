# 1 "../source/R_RTOS/R_RTOS_scheduler.c"
...
# 1 "../source/R_RTOS/R_RTOS_scheduler.c"
# 9 "../source/R_RTOS/R_RTOS_scheduler.c"
...
# 10 "../source/R_RTOS/R_RTOS_scheduler.c" 2
...
# 12 "../source/R_RTOS/R_RTOS_scheduler.c" 2
...
# 13 "../source/R_RTOS/R_RTOS_scheduler.c" 2
...
# 14 "../source/R_RTOS/R_RTOS_scheduler.c" 2
...
# 16 "../source/R_RTOS/R_RTOS_scheduler.c" 2


extern PTskTCB pIDLETsk;
extern uint8_t numTsks;
extern TskTCB tsk_AR[((uint8_t)0x4u)];
# 32 "../source/R_RTOS/R_RTOS_scheduler.c"
volatile PTskTCB p_cur_tsk_tcb = ((void *)0x0u);
extern volatile PTskTCB p_cur_tsk_tcb;
# 44 "../source/R_RTOS/R_RTOS_scheduler.c"
volatile PTskTCB p_nxt_tsk_tcb = ((void *)0x0u);
extern volatile PTskTCB p_nxt_tsk_tcb;
# 54 "../source/R_RTOS/R_RTOS_scheduler.c"
...
static TskPrioArEle ar_TskActvPrioSorted[(TskPrioLvl)0xFu ];
...
RetCode tsk_rmvTskActvTskLst( PTskTCB const tsk )
{
    ...
    if ( curPrioArElmnt->fstTsk == tskID )
    {
        ...
        if ( tsk_AR[tsk->nxtTsk].tskPrio.visibleTskPrio != tskPrio )
        {
            ...
            curPrioArElmnt->fstTsk = ((TskID)0x0u);





            curPrioArElmnt->lstTsk = ((TskID)0x0u);
    ...
    {
# 137 "../source/R_RTOS/R_RTOS_scheduler.c"
...
# 184 "../source/R_RTOS/R_RTOS_scheduler.c"
    if ( tmpPrioArElmnt->fstTsk != ((TskID)0x0u) )
    {
# 196 "../source/R_RTOS/R_RTOS_scheduler.c"
    ...
    {
# 226 "../source/R_RTOS/R_RTOS_scheduler.c"
        tmpPrioArElmnt->fstTsk = tskID;

        tmpPrioArElmnt->lstTsk = tskID;
# 252 "../source/R_RTOS/R_RTOS_scheduler.c"
...
# 275 "../source/R_RTOS/R_RTOS_scheduler.c"
        ...
        tsk->nxtTsk = tsk_AR[tmpPrioArElmnt->lstTsk].nxtTsk;
        tsk_AR[tsk->nxtTsk].prvTsk = tskID;
...
void os_INIT_Scheduler( void )
{
    uint8_t cntr = (TskPrioLvl)0xFu;
    while ( cntr-- )
    {
        ar_TskActvPrioSorted[cntr].fstTsk = ((TskID)0x0u);
        ar_TskActvPrioSorted[cntr].lstTsk = ((TskID)0x0u);
    }
    prioSlots = 0x1u << 0xFu;
}
...
void os_SCHEDULE( void )
{
    if ( gOS_FLAGS.g_tskCriticalExecution )
    {
        return;
    }
    ...
    {
        if ( ( (uint32_t) p_cur_tsk_tcb != (uint32_t) ((void *)0x0u) ) && ( p_cur_tsk_tcb->tskState
        ...
        if ( !(TskState)((TskState)(p_nxt_tsk_tcb->tskState) & TSK_STATE_ACTIVE) )
        {
            BREAK();
        }
        ...
        if ( ( p_nxt_tsk_tcb
                != p_cur_tsk_tcb ) )
        {
            gOS_FLAGS.g_DispatchFlag = (uint8_t) ( ((OsCode)0x1u) & 0x3u );
            ((SCB_Type *) ((0xE000E000UL) + 0x0D00UL) )->ICSR |= (1UL << 28);
        }
    }
    gOS_FLAGS.g_needsScheduling = 0x0u;
}
