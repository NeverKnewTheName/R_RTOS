...
.Ltext0:
	...
	.section	.bss.gEvts,"aw",%nobits
	.align	2
	.type	gEvts, %object
	.size	gEvts, 48
gEvts:
	.space	48
	.section	.bss.memPoolID_EVT,"aw",%nobits
	.type	memPoolID_EVT, %object
	.size	memPoolID_EVT, 1
memPoolID_EVT:
	.space	1
...
BREAK:
.LFB0:
	.file 1 "../source/R_RTOS/R_RTOS_events.c"
	.loc 1 23 0
	.cfi_startproc
	push	{r7, lr}
...
.LFE0:
	.size	BREAK, .-BREAK
	.section	.text.evt_INIT,"ax",%progbits
	.align	2
	.global	evt_INIT
	.code	16
	.thumb_func
...
.L8:
	...
	.cfi_endproc
.LFE1:
	.size	evt_INIT, .-evt_INIT
	.section	.text.evt_WaitForEvts,"ax",%progbits
	.align	2
	.global	evt_WaitForEvts
	.code	16
	.thumb_func
	.type	evt_WaitForEvts, %function
evt_WaitForEvts:
.LFB2:
	.loc 1 47 0
	.cfi_startproc
...
.L16:
	...
	.cfi_endproc
.LFE2:
	.size	evt_WaitForEvts, .-evt_WaitForEvts
	.section	.text.evt_SendEvt,"ax",%progbits
	.align	2
	.global	evt_SendEvt
	.code	16
	.thumb_func
	.type	evt_SendEvt, %function
evt_SendEvt:
.LFB3:
	.loc 1 93 0
	.cfi_startproc
...
.L23:
	...
	.cfi_endproc
.LFE3:
	.size	evt_SendEvt, .-evt_SendEvt
	.section	.text.evt_GiveUpOnEvts,"ax",%progbits
	.align	2
	.global	evt_GiveUpOnEvts
	.code	16
	.thumb_func
	.type	evt_GiveUpOnEvts, %function
evt_GiveUpOnEvts:
.LFB4:
	.loc 1 128 0
	.cfi_startproc
...
.L32:
	...
	.cfi_endproc
.LFE4:
	.size	evt_GiveUpOnEvts, .-evt_GiveUpOnEvts
	.text
.Letext0:
...
.Ldebug_macro0:
	...
	.4byte	.Ldebug_macro4
	.byte	0x4
	.file 8 "../include/R_RTOS_events.h"
	.byte	0x3
	.uleb128 0xa
	.uleb128 0x8
	.byte	0x5
...
.LASF852:
	.ascii	"../source/R_RTOS/R_RTOS_events.c\000"
.LASF470:
