# 1 "../source/R_RTOS/R_RTOS_msgQueuing.c"
...
# 1 "../source/R_RTOS/R_RTOS_msgQueuing.c"
# 17 "../source/R_RTOS/R_RTOS_msgQueuing.c"
...
# 13 "../include/R_RTOS_msgQueuing.h" 2
...
typedef enum mntrAccessState
{
    ...
    MNTR_RPW = (mntrFlgs) 0x72u,
    MNTR_WPW = (mntrFlgs) 0x62u
} MntrState;
...
RetCode msgQ_takeDataFrmQ(
                           ...
                           const TskID tskID,
                           PMQData * data );
# 18 "../source/R_RTOS/R_RTOS_msgQueuing.c" 2
# 1 "../include/R_RTOS_memMngr.h" 1
# 19 "../source/R_RTOS/R_RTOS_msgQueuing.c" 2
# 1 "../include/R_RTOS_monitor.h" 1
# 20 "../source/R_RTOS/R_RTOS_msgQueuing.c" 2
...
# 21 "../source/R_RTOS/R_RTOS_msgQueuing.c" 2

extern TskTCB tsk_AR[((uint8_t)0xBu)];
extern SysFkt sys_SysFkt[];
# 33 "../source/R_RTOS/R_RTOS_msgQueuing.c"
static MsgQ msgQ_AR[(QID)(0x3u) ];
...
# 54 "../source/R_RTOS/R_RTOS_msgQueuing.c"
static PMQPrtcpnt msgQ_getPartFrmLst( MQPrtcpnts lst, uint16_t fullID )
{


    while ( (uint32_t) lst != (uint32_t) ((void *)0x0u) )
    {
    ...
    return (PMQPrtcpnt) ((void *)0x0u);
}
# 79 "../source/R_RTOS/R_RTOS_msgQueuing.c"
static RetCode msgQ_emptyPublshrLst( PMQPrtcpnt publshrLst )
{
    PMQPrtcpnt curPublshr = publshrLst;
    while ( (uint32_t) curPublshr != (uint32_t) ((void *)0x0u) )
    {
        publshrLst = curPublshr->nxtMQPrtcpnt;
        rFree( curPublshr );
        curPublshr = publshrLst;
    }
    return ((RetCode)0x1u);
}
# 101 "../source/R_RTOS/R_RTOS_msgQueuing.c"
static RetCode msgQ_emptySubscrbrLst( PMQPrtcpnt subscrbrLst )
{
    PMQPrtcpnt curSubscrbr = subscrbrLst;
    while ( (uint32_t) curSubscrbr != (uint32_t) ((void *)0x0u) )
    {
        subscrbrLst = curSubscrbr->nxtMQPrtcpnt;
        if ( curSubscrbr->mqPrtcpntID.snglID[PartID_TSK] )
        {
            rFree( curSubscrbr->MQElmnt.sub.mqSubT.tskSub.tskMailBox );
            tsk_AR[curSubscrbr->mqPrtcpntID.snglID[PartID_TSK]].tskMailBox =
                    (PTskMB) ((void *)0x0u);
        }
        rFree( curSubscrbr );
        curSubscrbr = subscrbrLst;
    }
    return ((RetCode)0x1u);
}
# 127 "../source/R_RTOS/R_RTOS_msgQueuing.c"
static RetCode msgQ_emptyMsgQ( MsgQ * const queue )
{

    msgQ_emptyPublshrLst( queue->pubs );
    queue->pubs = (PMQPrtcpnt) ((void *)0x0u);

    msgQ_emptySubscrbrLst( queue->subs );
    queue->subs = (PMQPrtcpnt) ((void *)0x0u);

    return ((RetCode)0x1u);
}
# 148 "../source/R_RTOS/R_RTOS_msgQueuing.c"
...
# 191 "../source/R_RTOS/R_RTOS_msgQueuing.c"
static RetCode msgQ_notifySubscrbrs( MQPrtcpnts subLst )
{
    while ( (uint32_t) subLst != (uint32_t) ((void *)0x0u) )
    {
        if ( (uint8_t)((uint16_t)subLst->mqPrtcpntID.fullID & (uint16_t)0xFFu) )
        {

            if ( (uint32_t) subLst->MQElmnt.sub.mqSubT.tskSub.tskMailBox != (uint32_t) ((void *)0x0u) )
            {
                subLst->MQElmnt.sub.mqSubT.tskSub.tskMailBox->msgProv.msgQMsgProv.msgsNew =
                        ( subLst->MQElmnt.sub.mqSubT.tskSub.tskMailBox->msgProv.msgQMsgProv.msgsNew + (MsgCntr) 0x1u ) & (uint8_t)((uint8_t)0x8u -(uint8_t)0x1u);
            }
            else
            {
        ...
        else
        {
            ...
            subLst->MQElmnt.sub.mqSubT.sysSub.msgCallBack->msgProv.msgQMsgProv.msgsNew =
                    ( subLst->MQElmnt.sub.mqSubT.sysSub.msgCallBack->msgProv.msgQMsgProv.msgsNew + (MsgCntr) 0x1u ) & (uint8_t)((uint8_t)0x8u -(uint8_t)0x1u);
        }
        subLst = subLst->nxtMQPrtcpnt;
    }
    return ((RetCode)0x1u);
}
...
RetCode msgQ_initQueue( QID msgQID )
{
    ...
    while ( dataCntr-- )
    {
        ...
        msgQ->dataQueue[dataCntr].data = (CData) ((void *)0x0u);
    }

    msgQ->pubs = (MQPrtcpnts) ((void *)0x0u);
    msgQ->subs = (MQPrtcpnts) ((void *)0x0u);
    msgQ->queueID = msgQID;
...
RetCode msgQ_delQueue( const QID msgQID )
{
    ...
    msgQ->pubs = (PMQPrtcpnt) ((void *)0x0u);

    msgQ_emptySubscrbrLst( msgQ->subs );
    msgQ->subs = (PMQPrtcpnt) ((void *)0x0u);
    ...
    while ( dataCntr-- )
    {
        ...
        if ( (uint8_t)( msgQ->dataQueue[dataCntr].dataType & (uint8_t)0x4u) )
        {
...
RetCode msgQ_regTskPub( PTskTCB const pubTsk, const QID msgQID )
{
    ...
    PMQPrtcpnt tmpPublshr = msgQ_getPartFrmLst(
            msgQ->pubs, (uint16_t)(uint16_t)((uint8_t)pubTsk->tskID & (uint8_t)0xFFu) );

    if ( (uint32_t) tmpPublshr != (uint32_t) ((void *)0x0u) )
    {
        tmpPublshr->MQElmnt.pub.publisher = pubTsk;
        return ((RetCode)0x1u);
    }
    tmpPublshr = (PMQPrtcpnt) rMalloc( sizeof(MQPrtcpnt) );
    if ( (uint32_t) tmpPublshr != (uint32_t) ((void *)0x0u) )
    {
        tmpPublshr->mqPrtcpntID.fullID = (uint16_t)(uint16_t)((uint8_t)pubTsk->tskID & (uint8_t)0xFFu);
        tmpPublshr->MQElmnt.pub.publisher = pubTsk;
...
# 334 "../source/R_RTOS/R_RTOS_msgQueuing.c"
RetCode msgQ_regTskSub( PTskTCB const subTsk, const QID msgQID )
{
    ...
    PMQPrtcpnt tmpSubscrbr = msgQ_getPartFrmLst(
            msgQ->subs, (uint16_t)(uint16_t)((uint8_t)subTsk->tskID & (uint8_t)0xFFu) );
# 354 "../source/R_RTOS/R_RTOS_msgQueuing.c"
    if ( (uint32_t) tmpSubscrbr != (uint32_t) ((void *)0x0u) )
    {
    ...
    tmpSubscrbr = (PMQPrtcpnt) rMalloc( sizeof(MQPrtcpnt) );
    if ( (uint32_t) tmpSubscrbr != (uint32_t) ((void *)0x0u) )
    {
        ...
        ++( msgQ->subscbrCnt );
        PTskMB mqMailBox = (PTskMB) rMalloc( sizeof(TskMB) );
        if ( (uint32_t) mqMailBox != (uint32_t) ((void *)0x0u) )
        {
            ...
            tmpSubscrbr->mqPrtcpntID.fullID = (uint16_t)(uint16_t)((uint8_t)subTsk->tskID & (uint8_t)0xFFu);
...
RetCode msgQ_regSysSub( const SysFktID subSysFktID, const QID msgQID )
{
    ...
    PMQPrtcpnt tmpSubscrbr = (PMQPrtcpnt) msgQ_getPartFrmLst(
            msgQ->subs, (uint16_t)((uint16_t)((uint8_t)subSysFktID & (uint8_t)0xFFu) << (uint8_t)0x8u) );
    ...
    if ( (uint32_t) tmpSubscrbr == (uint32_t) ((void *)0x0u) )
    {
        ...
        {
            ++( msgQ->subscbrCnt );
            tmpSubscrbr->mqPrtcpntID.fullID = (uint16_t)((uint16_t)((uint8_t)subSysFktID & (uint8_t)0xFFu) << (uint8_t)0x8u);
...
RetCode msgQ_unSub( const QID msgQID, const uint16_t id )
{
    ...
    PMQPrtcpnt prvSubscrbr = (PMQPrtcpnt) ((void *)0x0u);

    while ( (uint32_t) tmpSubscrbr != (uint32_t) ((void *)0x0u) )
    {
        if ( tmpSubscrbr->mqPrtcpntID.fullID == id )
        {
            if ( (uint32_t) prvSubscrbr != (uint32_t) ((void *)0x0u) )
                prvSubscrbr->nxtMQPrtcpnt = tmpSubscrbr->nxtMQPrtcpnt;

            if ( (uint8_t)((uint16_t)id & (uint16_t)0xFFu) )
            {

                rFree( tmpSubscrbr->MQElmnt.sub.mqSubT.tskSub.tskMailBox );
...
static PMQData msgQ_popCircBuff( PMsgQ const msgQ )
{
    if ( msgQ->dataQueueEnd == msgQ->dataQueueStart )
        return (PMQData) ((void *)0x0u);




    --( msgQ->dataQueueEnd );
    msgQ->dataQueueEnd &= (uint8_t)((uint8_t)0x8u -(uint8_t)0x1u);

    return &( msgQ->dataQueue[msgQ->dataQueueEnd ] );
}
...
static PMQData msgQ_pushCircBuff( PMsgQ const msgQ )
{
    ...
    if ( msgQ->dataQueueEnd == msgQ->dataQueueStart )
    {
        ...
        ++( msgQ->dataQueueStart );
        msgQ->dataQueueStart &= (uint8_t)((uint8_t)0x8u -(uint8_t)0x1u);
...
# 536 "../source/R_RTOS/R_RTOS_msgQueuing.c"
RetCode msgQ_readDataFrmQ( const QID msgQID, const TskID tskID, PMQData *data )
{
    ...
    if ( (uint32_t) ( subscrbr ) == (uint32_t) ((void *)0x0u) )
    {
    ...
    if ( tskMailBox->msgProv.msgQMsgProv.msgsNew )
    {
        ...
        *data = &msgQ->dataQueue[( msgQ->dataQueueEnd
                - (uint8_t) tskMailBox->msgProv.msgQMsgProv.msgsNew )
                                 & (uint8_t)((uint8_t)0x8u -(uint8_t)0x1u) ];
