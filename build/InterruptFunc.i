# 1 "../hal/mcu/NXP_KL05/source/InterruptFunc.c"
...
# 1 "../hal/mcu/NXP_KL05/source/InterruptFunc.c"
# 9 "../hal/mcu/NXP_KL05/source/InterruptFunc.c"
...
# 10 "../hal/mcu/NXP_KL05/source/InterruptFunc.c" 2
...
# 11 "../hal/mcu/NXP_KL05/source/InterruptFunc.c" 2
...
# 12 "../hal/mcu/NXP_KL05/source/InterruptFunc.c" 2
...
# 13 "../hal/mcu/NXP_KL05/source/InterruptFunc.c" 2
...
# 15 "../hal/mcu/NXP_KL05/source/InterruptFunc.c" 2
# 27 "../hal/mcu/NXP_KL05/source/InterruptFunc.c"
#undef NULL
#define NULL ((void *)0)


#define NUM_INT_HANDLER_CONTAINER ((uint8_t)12u)
# 45 "../hal/mcu/NXP_KL05/source/InterruptFunc.c"
...
{ ((void *)0),
# 82 "../hal/mcu/NXP_KL05/source/InterruptFunc.c"
  g_ISRFktNr_TPM0,
  g_ISRFktNr_TPM1,
  ...
  g_ISRFktNr_PIT,
  g_ISRFktNr_LPTPMR0, g_ISRFktNr_PORTA, g_ISRFktNr_PORTB };



static volatile FuncPtr *g_IRQArr;
static uint8_t g_IRQArrSize = (uint8_t) 0x0u;
# 112 "../hal/mcu/NXP_KL05/source/InterruptFunc.c"
void installIrq( FuncPtr func, IRQIndex module, uint8_t entity )
{
    ...
    else
    {
        ...
        {
            g_IRQArr = (volatile FuncPtr *) rRealloc(
                    (FuncPtr) g_IRQArr,
                    ( uint16_t )( g_IRQArrSize * sizeof(FuncPtr) ) );

        }
        else
        {
            g_IRQArr = (volatile FuncPtr *) rRealloc(
                    ((void *)0), ( uint16_t )( g_IRQArrSize * sizeof(FuncPtr) ) );


        }
        g_IRQArr[g_IRQArrSize - (uint8_t) 0x1u] = func;
        g_ISRFktNr_Modules[module][entity] = ( uint8_t )(
                g_IRQArrSize - (uint8_t) 0x1u );
    }
}
# 253 "../hal/mcu/NXP_KL05/source/InterruptFunc.c"
void TPM0_IRQHandler( void )
{
    uint8_t tpm0Channels = ( (uint8_t) ( (((TPM_Type *)(0x40038000u)))->STATUS & (uint32_t)0x3Fu ) );
    (((TPM_Type *)(0x40038000u)))->STATUS |= (uint32_t)0x13Fu;
...
# 327 "../hal/mcu/NXP_KL05/source/InterruptFunc.c"
void TPM1_IRQHandler( void )
{
    uint8_t tpm1Channels = ( (uint8_t) ( (((TPM_Type *)(0x40039000u)))->STATUS & (uint32_t)0x3Fu ) );
    (((TPM_Type *)(0x40039000u)))->STATUS |= (uint32_t)0x13Fu;
...
# 408 "../hal/mcu/NXP_KL05/source/InterruptFunc.c"
void PIT_IRQHandler( void )
{
...
# 460 "../hal/mcu/NXP_KL05/source/InterruptFunc.c"
void PORTA_IRQHandler( void )
{
    EfiFreePIN causingPin = (EfiFreePIN) 0x0u;
    __disable_irq();
    volatile uint32_t *isfr = &(((PORT_Type *)(0x40049000u)))->ISFR;

    while ( ( ( ( *isfr ) >> causingPin++ )
                    & ( (uint32_t) 0x1u ) )
            != ( (uint32_t) 0x1u ) )
    {
        ;
...
# 496 "../hal/mcu/NXP_KL05/source/InterruptFunc.c"
void PORTB_IRQHandler( void )
{
    EfiFreePIN causingPin = (EfiFreePIN) 0x0u;
    __disable_irq();
    volatile uint32_t *isfr = &(((PORT_Type *)(0x4004A000u)))->ISFR;
...
# 532 "../hal/mcu/NXP_KL05/source/InterruptFunc.c"
void setSensingForPin( const EfiFreePIN pin, const interruptEvent sensing )
{
    volatile uint32_t *regPin_PCR = &((( ( ((uint8_t)( (PortPIN)pin >> (uint8_t)12u )) ) ? ((PORT_Type *)(0x4004A000u)) : ((PORT_Type *)(0x40049000u)) ))->PCR[((uint8_t)((( (PortPIN)pin & (PortPIN)0xF0FFu ) & (PortPIN)0x7C) >> 0x2u ))])
                                                                 ;
    (((((uint8_t)( (PortPIN)pin >> (uint8_t)12u ))) ? ((GPIO_Type *)(0x400FF040u)) : ((GPIO_Type *)(0x400FF000u)))->PDDR) &= ~((uint32_t)( 0x1u << ((uint8_t)((( (PortPIN)(PortPIN)pin & (PortPIN)0xF0FFu ) & (PortPIN)0x7C) >> 0x2u )) ) );

    *regPin_PCR &= ~0xF0000u;
    *regPin_PCR |= (((uint32_t)(((uint32_t)(sensing))<<16))&0xF0000u);
}
