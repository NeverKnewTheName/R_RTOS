# 1 "../source/R_RTOS/R_RTOS_SysTickTMR.c"
...
# 1 "../source/R_RTOS/R_RTOS_SysTickTMR.c"
# 9 "../source/R_RTOS/R_RTOS_SysTickTMR.c"
...
# 10 "../source/R_RTOS/R_RTOS_SysTickTMR.c" 2
...
# 14 "../include/R_RTOS_SysTickTMR.h" 2
...
# 12 "../source/R_RTOS/R_RTOS_SysTickTMR.c" 2
...
# 13 "../source/R_RTOS/R_RTOS_SysTickTMR.c" 2
...
# 15 "../source/R_RTOS/R_RTOS_SysTickTMR.c" 2

# 1 "../hal/mcu/NXP_KL05/BSP/include/MKL05Z4.h" 1
# 17 "../source/R_RTOS/R_RTOS_SysTickTMR.c" 2
...
# 48 "../source/R_RTOS/R_RTOS_SysTickTMR.c"
static volatile PSysTickTMR ar_PSysTickTMR[(uint8_t)0x8u ];
...
static RetCode sysTck_UpdateSysTckTMRs( SysTicks sysTcksDecr )
{
    ...
    ar_PSysTickTMR[sysTcksDecr] = (PSysTickTMR) ((void *)0x0u);
    PSysTickTMR tmpNxtSysTckTMR;
    while ( (uint32_t) tmpSysTckTMR != (uint32_t) ((void *)0x0u) )
    {

        tmpNxtSysTckTMR = tmpSysTckTMR->nxtSysTickTMR;
# 98 "../source/R_RTOS/R_RTOS_SysTickTMR.c"
        ...
        if ( (uint32_t) tmpSysTckTMR->nxtSysTickTMR != (uint32_t) ((void *)0x0u) )
        {
            tmpSysTckTMR->nxtSysTickTMR->prvSysTickTMR =
                    tmpSysTckTMR->prvSysTickTMR;
        }
        if ( (uint32_t) tmpSysTckTMR->prvSysTickTMR != (uint32_t) ((void *)0x0u) )
        {
        ...
        if ( !tmpSysTckTMR->remSysTicks )
        {
            ...
            if ( tmpSysTckTMR->sysTckObjType & SysTckObj_Tsk )
            {
                ...
                tmpTsk->sysTckTmr = (PSysTickTMR) ((void *)0x0u);
            }
            else if ( tmpSysTckTMR->sysTckObjType & SysTckObj_SysFkt )
            {
                ...
                if ( sysTckFktCall->reloadTime )
                {
                    ...
                    tmpSysTckTMR->prvSysTickTMR = (PSysTickTMR) ((void *)0x0u);
                    ar_PSysTickTMR[( os_SysTicks + tmpSysTckTMR->remSysTicks )
                            & (uint8_t)((uint8_t)0x8u - (uint8_t)0x1u) ] = tmpSysTckTMR;
                }
                else
                {

                    memMngr_MemPoolFree( tmpSysTckTMR, memPoolID_SysTckTMR );
                    sysTckFktCall->sysTckTmr = (PSysTickTMR) ((void *)0x0u);
                }
            }
        }
        else
...
void SysTick_Handler( void )
{
    ...
    sysTck_UpdateSysTckTMRs( os_SysTicks & (uint8_t)((uint8_t)0x8u - (uint8_t)0x1u) );

    SysTick_Config( (uint32_t) os_TimeSlice );
# 258 "../source/R_RTOS/R_RTOS_SysTickTMR.c"
    os_SCHEDULE();
    __enable_irq();
}
...
RetCode sysTck_INIT( void )
{
    uint8_t cntr = (uint8_t)0x8u;
    while ( cntr-- )
    {
        ar_PSysTickTMR[cntr] = (PSysTickTMR) ((void *)0x0u);
    }

    return memMngr_CreateMemPool(
            sizeof(SysTickTMR), (uint8_t)0x4u, &memPoolID_SysTckTMR );
}
                             ...
                             const uint8_t objID )
{
    ...
    if ( (uint32_t) tmpSysTckTMR != (uint32_t) ((void *)0x0u) )
    {
        tmpSysTckTMR->sysTckObjType = objType;
        tmpSysTckTMR->remSysTicks = sysTcksToWait;
        tmpSysTckTMR->insrtnSysTicksTime = os_SysTicks & (uint8_t)((uint8_t)0x8u - (uint8_t)0x1u);
        tmpSysTckTMR->nxtSysTickTMR = ar_PSysTickTMR[( os_SysTicks
                + sysTcksToWait )
                                                     & (uint8_t)((uint8_t)0x8u - (uint8_t)0x1u) ];
        if ( (uint32_t) tmpSysTckTMR->nxtSysTickTMR != (uint32_t) ((void *)0x0u) )
            tmpSysTckTMR->nxtSysTickTMR->prvSysTickTMR = tmpSysTckTMR;
        tmpSysTckTMR->prvSysTickTMR = (PSysTickTMR) ((void *)0x0u);
        ar_PSysTickTMR[( os_SysTicks + sysTcksToWait ) & (uint8_t)((uint8_t)0x8u - (uint8_t)0x1u) ] =
                tmpSysTckTMR;
