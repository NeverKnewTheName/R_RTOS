...
tsk1:
.LFB62:
	.file 1 "../Tasks/MessageQueueTest/Tasks.c"
	.loc 1 22 0
	.cfi_startproc
	push	{r7, lr}
...
.LBB28:
.LBB29:
	.file 2 "../include/R_RTOS_services.h"
	.loc 2 260 0
	ldr	r3, [r7, #24]
@ 260 "../include/R_RTOS_services.h" 1
	movs r0, r3 
...
@ 0 "" 2
	...
	.code	16
	mov	r3, #1
@ 261 "../include/R_RTOS_services.h" 1
	movs r1, r3 

@ 0 "" 2
	.loc 2 262 0
@ 262 "../include/R_RTOS_services.h" 1
	svc #15 

@ 0 "" 2
	.loc 2 264 0
@ 264 "../include/R_RTOS_services.h" 1
	mrs     r1,     msp 
 ldr r0, [r1] 
 movs r2, r0 
...
.LBB31:
	...
	mov	r3, #1
@ 298 "../include/R_RTOS_services.h" 1
	movs r0, r3 
...
@ 0 "" 2
	...
	.code	16
	mov	r3, #4
@ 299 "../include/R_RTOS_services.h" 1
	movs r1, r3 
...
@ 0 "" 2
	...
	.code	16
	mov	r3, #1
@ 300 "../include/R_RTOS_services.h" 1
	movs r2, r3 
...
@ 0 "" 2
	...
	.code	16
	ldr	r3, [r7, #16]
@ 301 "../include/R_RTOS_services.h" 1
	movs r3, r3 

@ 0 "" 2
	.loc 2 302 0 discriminator 1
@ 302 "../include/R_RTOS_services.h" 1
	svc #18 

@ 0 "" 2
	.loc 2 304 0 discriminator 1
@ 304 "../include/R_RTOS_services.h" 1
	mrs     r1,     msp 
 ldr r0, [r1] 
 movs r2, r0 
...
.LBB33:
	...
	mov	r3, #100
@ 216 "../include/R_RTOS_services.h" 1
	movs r0, r3 
...
@ 0 "" 2
	...
	.code	16
	ldr	r3, [r7, #8]
@ 217 "../include/R_RTOS_services.h" 1
	movs r1, r3 

@ 0 "" 2
	.loc 2 218 0 discriminator 1
@ 218 "../include/R_RTOS_services.h" 1
	svc #11 

@ 0 "" 2
	.loc 2 220 0 discriminator 1
@ 220 "../include/R_RTOS_services.h" 1
	mrs     r1,     msp 
 ldr r0, [r1] 
 movs r2, r0 
...
.LBB41:
	.loc 2 272 0
	ldr	r3, [r7, #32]
@ 272 "../include/R_RTOS_services.h" 1
	movs r0, r3 
...
@ 0 "" 2
	...
	.code	16
	mov	r3, #1
@ 273 "../include/R_RTOS_services.h" 1
	movs r1, r3 

@ 0 "" 2
	.loc 2 274 0
@ 274 "../include/R_RTOS_services.h" 1
	svc #16 

@ 0 "" 2
	.loc 2 276 0
@ 276 "../include/R_RTOS_services.h" 1
	mrs     r1,     msp 
 ldr r0, [r1] 
 movs r2, r0 
...
.LBB43:
	.loc 2 313 0
	mov	r3, #1
@ 313 "../include/R_RTOS_services.h" 1
	movs r0, r3 
...
@ 0 "" 2
	...
	add	r3, r3, #30
	ldrb	r3, [r3]
@ 314 "../include/R_RTOS_services.h" 1
	movs r1, r3 
...
@ 0 "" 2
	...
	.code	16
	ldr	r3, [r7, #24]
@ 315 "../include/R_RTOS_services.h" 1
	movs r2, r3 

@ 0 "" 2
	.loc 2 316 0
@ 316 "../include/R_RTOS_services.h" 1
	svc #19 

@ 0 "" 2
	.loc 2 318 0
@ 318 "../include/R_RTOS_services.h" 1
	mrs     r1,     msp 
 ldr r0, [r1] 
 movs r2, r0 
...
.LFE65:
	.size	tsk4, .-tsk4
	.section	.text.actvTsk1,"ax",%progbits
	.align	2
	.global	actvTsk1
	.code	16
	.thumb_func
	.type	actvTsk1, %function
actvTsk1:
.LFB66:
	.loc 1 141 0
	.cfi_startproc
...
.L60:
	...
	.cfi_endproc
.LFE66:
	.size	actvTsk1, .-actvTsk1
	.section	.text.actvTsk2,"ax",%progbits
	.align	2
	.global	actvTsk2
	.code	16
	.thumb_func
	.type	actvTsk2, %function
actvTsk2:
.LFB67:
	.loc 1 147 0
	.cfi_startproc
...
.L63:
	...
	.cfi_endproc
.LFE67:
	.size	actvTsk2, .-actvTsk2
	.section	.text.actvTsk3,"ax",%progbits
	.align	2
	.global	actvTsk3
	.code	16
	.thumb_func
	.type	actvTsk3, %function
actvTsk3:
.LFB68:
	.loc 1 153 0
	.cfi_startproc
...
.L66:
	...
	.cfi_endproc
.LFE68:
	.size	actvTsk3, .-actvTsk3
	.section	.text.actvTsk4,"ax",%progbits
	.align	2
	.global	actvTsk4
	.code	16
	.thumb_func
	.type	actvTsk4, %function
actvTsk4:
.LFB69:
	.loc 1 159 0
	.cfi_startproc
...
.L69:
	...
	.cfi_endproc
.LFE69:
	.size	actvTsk4, .-actvTsk4
	.section	.text.OS_START,"ax",%progbits
	.align	2
	.global	OS_START
	.code	16
	.thumb_func
...
.LFE70:
	...
	.text
.Letext0:
	.file 3 "c:\\freescale\\kds_3.0.0\\toolchain\\arm-none-eabi\\include\\machine\\_default_types.h"
	.file 4 "c:\\freescale\\kds_3.0.0\\toolchain\\arm-none-eabi\\include\\stdint.h"
	.file 5 "../hal/mcu/NXP_KL05/BSP/include/MKL05Z4.h"
	.file 6 "../hal/mcu/NXP_KL05/include/PortFunc.h"
...
.Ldebug_macro0:
	...
	.byte	0x7
	.4byte	.Ldebug_macro1
	.file 8 "c:\\freescale\\kds_3.0.0\\toolchain\\lib\\gcc\\arm-none-eabi\\4.8.4\\include\\stdint.h"
	.byte	0x3
	.uleb128 0x70
	.uleb128 0x8
	.byte	0x3
	...
	.uleb128 0x6
	.4byte	.LASF346
	.file 9 "c:\\freescale\\kds_3.0.0\\toolchain\\arm-none-eabi\\include\\sys\\features.h"
	.byte	0x3
	.uleb128 0x8
	.uleb128 0x9
	.byte	0x7
	...
	.byte	0x7
	.4byte	.Ldebug_macro5
	.file 10 "../hal/proc/ARM_cortex-m0plus/core_cm0plus.h"
	.byte	0x3
	.uleb128 0xc4
	.uleb128 0xa
	.byte	0x7
	.4byte	.Ldebug_macro6
	.file 11 "../hal/proc/ARM_cortex-m0plus/core_cmInstr.h"
	.byte	0x3
	.uleb128 0x93
	.uleb128 0xb
	.byte	0x7
	.4byte	.Ldebug_macro7
	.byte	0x4
	.file 12 "../hal/proc/ARM_cortex-m0plus/core_cmFunc.h"
	.byte	0x3
	.uleb128 0x94
	.uleb128 0xc
	.byte	0x5
	...
	.4byte	.LASF4351
	.byte	0x4
	.file 16 "../include/R_RTOS_timer.h"
	.byte	0x3
	.uleb128 0x7
	.uleb128 0x10
	.byte	0x7
	...
	.byte	0x4
	.file 17 "../include/R_RTOS_msgQueuing.h"
	.byte	0x3
	.uleb128 0x8
	.uleb128 0x11
	.byte	0x5
	.uleb128 0xa
	.4byte	.LASF4356
	.file 18 "../include/R_RTOS_monitor.h"
	.byte	0x3
	.uleb128 0xd
	.uleb128 0x12
	.byte	0x5
	.uleb128 0xa
	.4byte	.LASF4357
	.file 19 "../include/R_RTOS_memMngr.h"
	.byte	0x3
	.uleb128 0xd
	.uleb128 0x13
	.byte	0x7
...
.LASF4785:
	.ascii	"../Tasks/MessageQueueTest/Tasks.c\000"
.LASF2215:
