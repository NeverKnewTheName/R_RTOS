# 1 "../hal/mcu/NXP_KL05/source/PortFunc.c"
...
# 9 "../hal/mcu/NXP_KL05/source/PortFunc.c" 2
...
# 10 "../hal/mcu/NXP_KL05/source/PortFunc.c" 2
# 29 "../hal/mcu/NXP_KL05/source/PortFunc.c"
void initPin( const EfiFreePIN pin, const uint8_t mode, const uint8_t pullUp )
{
    if ( (pin & (EfiFreePIN)0xFFu) != ((PortPIN)0xFFu) )
    {

        ((((SIM_Type *)(0x40047000u)))->SCGC5) |= ( ((uint8_t)( (PortPIN)pin >> (uint8_t)12u )) ) ? 0x400u : 0x200u;
        ...
        *regPin_PCR &= (uint32_t)(~0x700u);

        *regPin_PCR |= (uint32_t)( (((uint32_t)(((uint32_t)(mode))<<8))&0x700u) );
...
# 84 "../hal/mcu/NXP_KL05/source/PortFunc.c"
void setPin( const EfiFreePIN pin, const uint8_t val )
{
    if ( pin != ((PortPIN)0xFFu) )
    {
        GPIO_Type * port = (((uint8_t)( (PortPIN)pin >> (uint8_t)12u ))) ? ((GPIO_Type *)(0x400FF040u)) : ((GPIO_Type *)(0x400FF000u));

        ((port)->PDDR) |= ((uint32_t)( 0x1u << ((uint8_t)((( (PortPIN)(PortPIN)pin & (PortPIN)0xF0FFu ) & (PortPIN)0x7C) >> 0x2u )) ) );

        volatile uint32_t *registerToBeSet = ((val) ? (&((port)->PSOR)) : (&((port)->PCOR)));
        *registerToBeSet |= ((uint32_t)( 0x1u << ((uint8_t)((( (PortPIN)(PortPIN)pin & (PortPIN)0xF0FFu ) & (PortPIN)0x7C) >> 0x2u )) ) );
    }
}
# 110 "../hal/mcu/NXP_KL05/source/PortFunc.c"
void togglePin( const EfiFreePIN pin )
{
    if ( pin != ((PortPIN)0xFFu) )
    {
        ...
        ((port)->PTOR) |= ((uint32_t)( 0x1u << ((uint8_t)((( (PortPIN)(PortPIN)pin & (PortPIN)0xF0FFu ) & (PortPIN)0x7C) >> 0x2u )) ) );
    }
}
# 136 "../hal/mcu/NXP_KL05/source/PortFunc.c"
uint8_t readPin( const EfiFreePIN pin )
{
    uint8_t pinLevel = (uint8_t)0xFFu;
    if ( pin != ((PortPIN)0xFFu) )
    {
        volatile uint32_t *regGPIO_PDDR = &((( ((uint8_t)( (PortPIN)pin >> (uint8_t)12u )) ) ? ((GPIO_Type *)(0x400FF040u)) : ((GPIO_Type *)(0x400FF000u)))->PDDR)
                                                   ;

        *regGPIO_PDDR &= ~((uint32_t)( 0x1u << ((uint8_t)((( (PortPIN)(PortPIN)pin & (PortPIN)0xF0FFu ) & (PortPIN)0x7C) >> 0x2u )) ) );

        pinLevel = (uint8_t) ( ( ((( ((uint8_t)( (PortPIN)pin >> (uint8_t)12u )) ) ? ((GPIO_Type *)(0x400FF040u)) : ((GPIO_Type *)(0x400FF000u)))->PDIR) & ((uint32_t)( 0x1u << ((uint8_t)((( (PortPIN)(PortPIN)pin & (PortPIN)0xF0FFu ) & (PortPIN)0x7C) >> 0x2u )) ) ) )
                >> ((uint8_t)((( (PortPIN)pin & (PortPIN)0xF0FFu ) & (PortPIN)0x7C) >> 0x2u )) );
    }
    return pinLevel;
}
