...
# 2 "../Tasks/MntrTest/RWR/Tasks.c" 2
...
# 3 "../Tasks/MntrTest/RWR/Tasks.c" 2
...
# 4 "../Tasks/MntrTest/RWR/Tasks.c" 2
...
# 6 "../Tasks/MntrTest/RWR/Tasks.c" 2
...
# 7 "../Tasks/MntrTest/RWR/Tasks.c" 2
...
void tsk1( void )
{
    ...
    svc_tsk_InitTsk( (TskID) 0x3u, &tsk3, &tsk_EndTheTask, ((StackSize)0x80u) );
...
void actvTsk2( void )
{
    tsk_tskInit( (TskID) 0x2u, &tsk2, &tsk_EndTheTask, ((StackSize)0x80u) );
