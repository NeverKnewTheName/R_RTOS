...
# 9 "../hal/mcu/NXP_KL05/source/ClockFunc.c" 2
...
# 10 "../hal/mcu/NXP_KL05/source/ClockFunc.c" 2
# 24 "../hal/mcu/NXP_KL05/source/ClockFunc.c"
uint32_t getBusClk(void)
{
    SystemCoreClockUpdate();
 return ((uint32_t)((uint32_t)SystemCoreClock / (uint32_t)(((((SIM_Type *)(0x40047000u))->CLKDIV1 & 0x70000u) >> 16) + 1)));
}
