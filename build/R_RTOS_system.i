# 1 "../source/R_RTOS/R_RTOS_system.c"
...
# 1 "../source/R_RTOS/R_RTOS_system.c"
# 9 "../source/R_RTOS/R_RTOS_system.c"
...
# 10 "../source/R_RTOS/R_RTOS_system.c" 2
...
# 12 "../source/R_RTOS/R_RTOS_system.c" 2
...
# 13 "../source/R_RTOS/R_RTOS_system.c" 2
...
# 14 "../source/R_RTOS/R_RTOS_system.c" 2


# 1 "../include/R_RTOS_system.h" 1
# 10 "../include/R_RTOS_system.h"
...
# 13 "../include/R_RTOS_system.h" 2
# 21 "../include/R_RTOS_system.h"
RetCode __initOS( void );
# 30 "../include/R_RTOS_system.h"
void tskIdle( void );
...
# 17 "../source/R_RTOS/R_RTOS_system.c" 2
# 1 "../include/R_RTOS_inc.h" 1
# 18 "../source/R_RTOS/R_RTOS_system.c" 2
...
# 20 "../source/R_RTOS/R_RTOS_system.c" 2
...
# 21 "../source/R_RTOS/R_RTOS_system.c" 2
...
# 24 "../include/R_RTOS_SysTickTMR.h"
void SysTick_Handler( void );
# 33 "../include/R_RTOS_SysTickTMR.h"
RetCode sysTck_INIT( void );
# 44 "../include/R_RTOS_SysTickTMR.h"
...
__attribute__( ( always_inline )) static inline RetCode svc_sem_wait(
                                                                         const SemNr semNr,
                                                                         PTskTCB const tsk,
                                                                         const SysTicks maxTimeToWait )
{
    ...
    __asm volatile( "movs r1, %0 \n"::"l"(tsk) :);
    __asm volatile( "movs r2, %0 \n"::"l"(maxTimeToWait) :);
    __asm volatile( "svc %[svc_code] \n" : : [svc_code]"I"(SVC_SEM_WAIT) : );
    RetCode returnVal;
    __asm volatile( "mrs     r1,     msp \n ldr r0, [r1] \n movs %0, r0 \n":"=l"(returnVal): :"memory");
    return returnVal;
}

__attribute__( ( always_inline )) static inline RetCode svc_sem_signal(
                                                                         const SemNr semNr,
                                                                         PTskTCB const tsk )
{
    __asm volatile( "movs r0, %0 \n"::"l"(semNr) :);
    __asm volatile( "movs r1, %0 \n"::"l"(tsk) :);
    __asm volatile( "svc %[svc_code] \n" : : [svc_code]"I"(SVC_SEM_SIGNAL) : );
    RetCode returnVal;
    __asm volatile( "mrs     r1,     msp \n ldr r0, [r1] \n movs %0, r0 \n":"=l"(returnVal): :"memory");
    return returnVal;
}

__attribute__( ( always_inline )) static inline RetCode svc_mntr_init_mntr(
                                                                         const MntrNr mntrNr,
                                                                         const Data data )
{
    __asm volatile( "movs r0, %0 \n"::"l"(mntrNr) :);
    __asm volatile( "movs r1, %0 \n"::"l"(data) :);
    __asm volatile( "svc %[svc_code] \n" : : [svc_code]"I"(SVC_MNTR_INIT_MNTR) : );
    RetCode returnVal;
    __asm volatile( "mrs     r1,     msp \n ldr r0, [r1] \n movs %0, r0 \n":"=l"(returnVal): :"memory");
    return returnVal;
}

__attribute__( ( always_inline )) static inline RetCode svc_mntr_ReqReadAccs(
                                                                         const MntrNr mntrNr,
                                                                         PTskTCB const tsk )
{
    __asm volatile( "movs r0, %0 \n"::"l"(mntrNr) :);
    __asm volatile( "movs r1, %0 \n"::"l"(tsk) :);
    __asm volatile( "svc %[svc_code] \n" : : [svc_code]"I"(SVC_MNTR_REQ_READ_ACC) : );
    RetCode returnVal;
    __asm volatile( "mrs     r1,     msp \n ldr r0, [r1] \n movs %0, r0 \n":"=l"(returnVal): :"memory");
    return returnVal;
}

__attribute__( ( always_inline )) static inline RetCode svc_mntr_ReqWriteAccs(
                                                                         const MntrNr mntrNr,
                                                                         PTskTCB const tsk )
{
    __asm volatile( "movs r0, %0 \n"::"l"(mntrNr) :);
    __asm volatile( "movs r1, %0 \n"::"l"(tsk) :);
    __asm volatile( "svc %[svc_code] \n" : : [svc_code]"I"(SVC_MNTR_REQ_WRITE_ACC) : );
    RetCode returnVal;
    __asm volatile( "mrs     r1,     msp \n ldr r0, [r1] \n movs %0, r0 \n":"=l"(returnVal): :"memory");
    return returnVal;
}
...
__attribute__( ( always_inline )) static inline RetCode svc_mntr_RelAccs(
                                                                         const MntrNr mntrNr )
{
    __asm volatile( "movs r0, %0 \n"::"l"(mntrNr) :);
    __asm volatile( "svc %[svc_code] \n" : : [svc_code]"I"(SVC_MNTR_REL_ACC) : );
    RetCode returnVal;
    __asm volatile( "mrs     r1,     msp \n ldr r0, [r1] \n movs %0, r0 \n":"=l"(returnVal): :"memory");
    return returnVal;
}
...
extern PTskTCB const pIDLETsk;
extern TskTCB tsk_AR[((uint8_t)0x4u)];
...
RetCode __initOS( void )
{
    ...
    ((SCB_Type *) ((0xE000E000UL) + 0x0D00UL) )->SHP[0] = (uint32_t) ( 0x00000000u );


    ((SCB_Type *) ((0xE000E000UL) + 0x0D00UL) )->SHP[1] = (uint32_t) ( 0x40C00000u );
...
# 163 "../source/R_RTOS/R_RTOS_system.c"
...
RetCode SVC_HandlerMain( uint32_t *svc_args )
{
...

    {
        case SVC_OS_START:
            ...
            pIDLETsk->pStckPtr += (uint32_t) 0x8u;
            __set_PSP( (uint32_t) pIDLETsk->pStckPtr );
            svc_EXCReturn = (uint32_t) 0xFFFFFFFDu;
        ...
        case SVC_CALL_FKT_PRIV:
            ...
            break;
        case SVC_LP_ENTER:
# 426 "../source/R_RTOS/R_RTOS_system.c"
            break;
        case SVC_TRC_OUPUT:
            break;
        default:
